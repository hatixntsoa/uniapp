...
final examRosterProvider =
    AsyncNotifierProvider.family<ExamRosterNotifier, List<GradeEntity>, String>(
      ExamRosterNotifier.new,
    );
...
class ExamRosterNotifier
  ...
  Future<void> updateGrade(GradeEntity grade) async {
    ...
    state = AsyncValue.data(
      await ref.read(examRepositoryProvider).getRoster(arg),
    );
  }
}

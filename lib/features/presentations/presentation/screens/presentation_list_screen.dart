        ...
        actions: [
          IconButton(
            ...
            onPressed: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (_) => const PresentationHistoryScreen()),
            ),
          ),
        ],
      ),
      ...
      body: presentationsAsync.when(
        ...
        data: (presentations) {
          ...
          return ListView(
            ...
            children: [
              const SectionHeader(eyebrow: 'Planification', title: 'Présentations & soutenances'),
              for (final p in presentations) ...[
                AppCard(
                  onTap: () => Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (_) => PresentationEvaluationScreen(presentation: p),
                    ),
                  ),
                  child: Row(
                    children: [
                      ...
                      PillBadge(
                        ...
                        color: p.isCompleted ? AppColors.success : AppColors.accent,
                      ),
                    ],
                  ),
                ),
